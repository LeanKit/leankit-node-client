...
module.exports = (api, request) => {
	...
	api.task.create = (boardId, cardId, taskCardObject, laneId = 0, position = defaultPosition, wipOverrideReason = defaultWipOverrideReason) => {
	...
	api.task.move = (boardId, cardId, taskId, toLaneId, position = defaultPosition) => {
		// eslint-disable-line max-params
		return request({
